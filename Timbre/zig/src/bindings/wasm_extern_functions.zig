...
pub extern "env" fn TimbreSoundManager_getBulkAudioAssetDuration_WASM(pathPtr: [*]const u8, pathLength: u32) f32;
pub extern "env" fn TimbreSoundManager_getBulkAudioAssetDurationByHash_WASM(pathHash: u32) f32;
pub extern "env" fn TimbreSoundManager_getBulkAudioAssetID_WASM(pathPtr: [*]const u8, pathLength: u32) u32;
pub extern "env" fn TimbreSoundManager_getBulkAudioAssetData_WASM(pathPtr: [*]const u8, pathLength: u32, valueBufferPtr: [*]u8, valueBufferLength: u32) c_int;
...
pub extern "env" fn EventDescription_createInstanceWithAutoPauseTickLevel_WASM(cppPtr: basis.CppPtr, autoPauseTickLevel: u32) basis.CppPtr;
...
pub extern "env" fn EventInstance_unpause_WASM(cppPtr: basis.CppPtr) void;
...
pub extern "env" fn EventInstance_setWaveAssetRefParameterByName_WASM(cppPtr: basis.CppPtr, namePtr: [*]const u8, nameLength: u32, waveAssetID: u32) void;
pub extern "env" fn EventInstance_setWaveAssetRefParameterByIndex_WASM(cppPtr: basis.CppPtr, index: u32, waveAssetID: u32) void;
