...
pub fn build(b: *std.Build) void {
    ...
    var lib = b.addLibrary(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/ghl.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const timbreModule = b.createModule(.{
        .root_source_file = b.path("../../Timbre/zig/src/timbre.zig"),
        .imports = &.{
    ...
    lib.root_module.addImport("timbre", timbreModule);
